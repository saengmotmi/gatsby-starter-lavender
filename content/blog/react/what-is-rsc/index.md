...
더 이상 내용 추가 안하겠다고 했는데... RSC를 활용한 SSR에 대한 전체 흐름이 담겨 있는 도표를 발견해서 덧붙이게 되었다. 이 그림은 Kent C.Dodds가 [RSC의 요청 흐름에 대해 정리한 도표](https://twitter.com/kentcdodds/status/1765769438132113779/photo/1)가 출처이다. 조금 복잡해보이지만 이 글에서 지금까지 다뤄온 내용들을 총 정리하는 목적으로 하나씩 따라가다보면 어렵지 않게 이해할 수 있을 것이라고 생각한다.
